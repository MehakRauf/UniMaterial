...
void myDisplay(void)
{
	...
	for (int i = 0; i < 13; i++) {
		for (int j = 0; j < 13; j++) {
			...
			drawPolyLineFile("C:\\Users\\Excalibur\\testing\\l3(Activity1)\\dino.dat");
		}
	}
	glutSwapBuffers();
}
...
int main(int argc, char** argv)
{
	...
	glutCreateWindow("Lab Activity (2): Modify myDisplay() and type and run the given Code1 to get the following output 1( Tiling)"); // open the screen windo
